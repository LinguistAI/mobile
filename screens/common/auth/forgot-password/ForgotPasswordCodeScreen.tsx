...
import { Animated, KeyboardAvoidingView, SafeAreaView, StyleSheet, Text } from 'react-native';
...
const ForgotPasswordCodeScreen = ({ navigation, route }: ForgotPasswordCodeScreenProps) => {
  ...
  return (
    <SafeAreaView>
      <KeyboardAvoidingView behavior="position" contentContainerStyle={styles.root}>
